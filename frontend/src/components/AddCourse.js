                ...
                <Form style={{ width: '40%' }}>
                    ...
                    <Form.Row>
                        <Form.Group as={Col} controlId="validationCustom01">
                            ...
                            <Col>
                                <Form.Control placeholder="รายละเอียด" className="font" style={{ marginTop: 5, marginBottom: 5 }}
                    ...
                    <Form.Row>
                        <Form.Group as={Col} controlId="validationCustom01">
                            ...
                            <Col>
                                <Form.Control placeholder="ราคา" className="font" style={{ marginTop: 5, marginBottom: 5 }}
